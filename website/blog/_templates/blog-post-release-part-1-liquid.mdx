...
cmake_release_date: "{{packageWebsiteConfig.cmakeReleaseDate}}"

version: "{{xpackVersion}}"
npm_subversion: "1"

download_url: https://github.com/xpack-dev-tools/cmake-xpack/releases/tag/v{{xpackVersion}}/
...
Version **{{xpackVersion}}** is a new release; it follows the upstream release.
