...
seo_title: Version 3.25.3-1 released
description: Version 3.25.3-1 is a new release of xPack CMake.
keywords:
  - xpack
  - cmake
  - release
...
Version **3.25.3-1** is a new release; it follows the upstream release.
