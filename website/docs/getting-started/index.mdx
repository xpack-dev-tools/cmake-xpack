...
**xPack CMake** is a standalone cross-platform (Windows, macOS, GNU/Linux)
binary distribution of CMake,
intended for reproducible builds.

<Overview/>

**xPack CMake** is an open source project hosted on GitHub as
...
[build scripts](https://github.com/xpack-dev-tools/cmake-xpack/tree/xpack/scripts).
