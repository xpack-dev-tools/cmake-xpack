...
title: Getting Started with xPack CMake
...
**xPack CMake** is a standalone
cross-platform (Windows, macOS, GNU/Linux)binary distribution of CMake,
...
[release assets](https://github.com/xpack-dev-tools/cmake-xpack/releases).

In addition to the binary archives and the package metadata,
this project also includes the
[build scripts](https://github.com/xpack-dev-tools/cmake-xpack/tree/xpack/build-assets/scripts).
...
[`cmake-xpack.git/build-assets/scripts`](https://github.com/xpack-dev-tools/cmake-xpack/tree/xpack/build-assets/scripts/)
...
- **Star** the project on [GitHub](https://github.com/xpack-dev-tools/cmake-xpack/): It helps others discover our work.
