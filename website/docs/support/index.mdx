...
title: How to get help for cmake
...
# How to get help for xPack CMake
...
distribution, not to the upstream CMake itself
(if you have doubts, use the GitHub Discussions),
or if you have a pertinent suggestion how to enhance the **xPack CMake**
