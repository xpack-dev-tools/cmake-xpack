...
# How to get help for the xPack CMake
...
similar topics
- Check the [GitHub Issues](https://github.com/xpack-dev-tools/cmake-xpack/issues)
tracker and the
...
others, please 
use the [GitHub Discussions](https://github.com/xpack-dev-tools/cmake-xpack/discussions)
pages.
