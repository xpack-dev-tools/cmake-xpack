...
The **xPack CMake** may be installed automatically, utilising the `xpm` command
(the recommended method), or manually, by downloading and unpacking one of the
platform-specific archives.

## Automated installation

The easiest (and recommended) method to install xPack CMake
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/xpack-dev-tools/cmake/3.31.9-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/xpack-dev-tools/cmake/3.31.9-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/xpack-dev-tools/cmake/3.31.9-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-cmake-3.31.9-1-win32-x64.zip</code></li>
</ul>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\cmake\\xpack-cmake-3.31.9-1</code>.
...
<ul>
<li><code>xpack-cmake-3.31.9-1-darwin-x64.tar.gz</code></li>
<li><code>xpack-cmake-3.31.9-1-darwin-arm64.tar.gz</code></li>
</ul>
...
example <code>/Users/ilg/Library/xPacks/cmake/xpack-cmake-3.31.9-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/cmake
cd ~/Library/xPacks/cmake

tar xvf ~/Downloads/xpack-cmake-3.31.9-1-darwin-x64.tar.gz
chmod -R -w xpack-cmake-3.31.9-1
`} </CodeBlock>
...
<ul>
<li><code>xpack-cmake-3.31.9-1-linux-x64.tar.gz</code></li>
<li><code>xpack-cmake-3.31.9-1-linux-arm64.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/cmake/xpack-cmake-3.31.9-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/cmake
cd ~/.local/xPacks/cmake

tar xvf ~/Downloads/xpack-cmake-3.31.9-1-linux-x64.tar.gz
chmod -R -w xpack-cmake-3.31.9-1
`} </CodeBlock>
