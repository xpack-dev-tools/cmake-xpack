...
[![npm (scoped)](https://img.shields.io/npm/v/%40xpack-dev-tools%2Fcmake?label=xpm&color=blue)](https://www.npmjs.com/package/@xpack-dev-tools/cmake/)
![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/xpack-dev-tools/cmake-xpack/total)
[![npm](https://img.shields.io/npm/dm/%40xpack-dev-tools%2Fcmake?label=xpm%20downloads)](https://www.npmjs.com/package/@xpack-dev-tools/cmake/)
...
The easiest (and recommended) way to install CMake
is via **xpm** and the package available
as <a href={`https://www.npmjs.com/package/@xpack-dev-tools/cmake`}><code>@xpack-dev-tools/cmake</code></a> from
...
<code>xpacks/@xpack-dev-tools/cmake</code>.
...
**cmake** package into the project.

The command to install the **latest** available version of **cmake** is:
...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/cmake@${customField('releaseVersion')} --verbose
`} </CodeBlock>
...
* identify the platform specific archive for the latest available version
  of CMake, download it into a cache and unpack
...
* create a local symbolic link
  like <code>xpacks/@xpack-dev-tools/cmake</code> pointing to the
...
* add links/forwarders into
  ...
  <code>xpacks/@xpack-dev-tools/cmake/.content/bin</code>;
* add <code>@xpack-dev-tools/cmake</code> to
  `package.json` as a
  development dependency; this associates a specific version of CMake with
...
it is also possible to install CMake only globally in
...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/cmake@latest --global --verbose
`} </CodeBlock>
...
In order to access the CMake binaries installed in
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/cmake/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/cmake/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/cmake/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`xpm uninstall @xpack-dev-tools/cmake --verbose
`} </CodeBlock>
...
the <a href={`https://github.com/xpack-dev-tools/cmake-xpack/releases`}>GitHub Releases</a> pages.
...
<ul>
<li><code>xpack-cmake-{customField('xpackVersion')}-win32-x64.zip</code></li>
</ul>
...
To manually install the <b>xPack CMake</b>,
unpack the archive and move it to a location of your choice.

The recommended location is
the <code>%USERPROFILE%\\AppData\\Roaming\\xPacks\\cmake</code> folder, for
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\cmake\\xpack-cmake-{customField('xpackVersion')}</code>.
...
<ul>
<li><code>xpack-cmake-{customField('xpackVersion')}-darwin-x64.tar.gz</code></li>
<li><code>xpack-cmake-{customField('xpackVersion')}-darwin-arm64.tar.gz</code></li>
</ul>
...
The recommended location is
the <code>~/Library/xPacks/cmake</code> folder, for
example <code>/Users/ilg/Library/xPacks/cmake/xpack-cmake-{customField('xpackVersion')}</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/cmake
cd ~/Library/xPacks/cmake

tar xvf ~/Downloads/xpack-cmake-${customField('xpackVersion')}-darwin-x64.tar.gz
chmod -R -w xpack-cmake-${customField('xpackVersion')}
`} </CodeBlock>
...
<ul>
<li><code>xpack-cmake-{customField('xpackVersion')}-linux-x64.tar.gz</code></li>
<li><code>xpack-cmake-{customField('xpackVersion')}-linux-arm64.tar.gz</code></li>
<li><code>xpack-cmake-{customField('xpackVersion')}-linux-arm.tar.gz</code></li>
</ul>
...
The recommended location is
the <code>~/.local/xPacks/cmake</code> folder, for
example <code>/home/ilg/.local/xPacks/cmake/xpack-cmake-{customField('xpackVersion')}</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/cmake
cd ~/.local/xPacks/cmake

tar xvf ~/Downloads/xpack-cmake-${customField('xpackVersion')}-linux-x64.tar.gz
chmod -R -w xpack-cmake-${customField('xpackVersion')}
`} </CodeBlock>
