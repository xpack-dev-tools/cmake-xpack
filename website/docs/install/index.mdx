...
- <code>xpack-cmake-{customField('xpackVersion')}-win32-x64.zip</code>
...
- <code>xpack-cmake-{customField('xpackVersion')}-darwin-x64.tar.gz</code>- <code>xpack-cmake-{customField('xpackVersion')}-darwin-arm64.tar.gz</code>
...
- <code>xpack-cmake-{customField('xpackVersion')}-linux-x64.tar.gz</code>- <code>xpack-cmake-{customField('xpackVersion')}-linux-arm64.tar.gz</code>- <code>xpack-cmake-{customField('xpackVersion')}-linux-arm.tar.gz</code>
