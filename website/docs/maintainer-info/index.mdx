...
title: Information for xPack CMake maintainers
...
```sh
bash ~/Work/xpack-dev-tools/cmake-xpack.git/build-assets/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-travis-macos.sh
```
...
named like **xPack CMake v{ customField('upstreamVersion') }-{ customField('xpackSubversion') }** (mind the dash),
...
- <code>npm dist-tag ls @xpack-dev-tools/cmake</code>
- <code>npm dist-tag add @xpack-dev-tools/cmake@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') } latest</code>
- <code>npm dist-tag ls @xpack-dev-tools/cmake</code>

In case the previous version is not functional and needs to be unpublished:

- <code>npm unpublish @xpack-dev-tools/cmake@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') }</code>
...
- the result is in https://xpack-dev-tools.github.io/cmake-xpack/blog/
...
- paste the release name like _**xPack CMake v{ customField('upstreamVersion') }-{ customField('xpackSubversion') } released**_
