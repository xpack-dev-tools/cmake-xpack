...
- determine the version (like <code>3.29.9-1.1</code>)
- update the version in top `package.json`
- use the new version, suffixed by `.pre`,
like <code>3.29.9-1.1.pre</code>.
...
Determine the version (like <code>3.29.9-1</code>)
and update the `build-assets/scripts/VERSION` file; the format
is <code>3.29.9-1</code>.
...
and fix them; assign them to a milestone (like <code>3.29.9-1</code>).
...
- add a new entry like _**\* v3.29.9-1 prepared**_
- commit with the message _**prepare v3.29.9-1**_
...
tagged like **v3.29.9-1** (mind the dash in the middle!) and
named like **xPack CMake v3.29.9-1** (mind the dash),
...
- commit with the message _**website: blog post release 3.29.9-1 published**_
...
- commit all changes with the message
  _**package.json: update urls for 3.29.9-1.1 release**_

### Publish on the npmjs.com server

- select the `xpack-development` branch
- check the latest commits `xpm run git-log`
- update `CHANGELOG.md`, add a line like _**\* v3.29.9-1.1 published on npmjs.com**_
- commit with the message _**CHANGELOG: publish npm v3.29.9-1.1**_
...
<CodeBlock language="sh"> {
`npm dist-tag add @xpack-dev-tools/cmake@3.29.9-1.1 latest
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`npm unpublish @xpack-dev-tools/cmake@3.29.9-1.1
`} </CodeBlock>
...
- paste the release name like _**xPack CMake v3.29.9-1 released**_
...
[![npm (scoped)](https://img.shields.io/npm/v/@xpack-dev-tools/cmake)](https://www.npmjs.com/package/@xpack-dev-tools/cmake/)
[![npm](https://img.shields.io/npm/dm/@xpack-dev-tools/cmake)](https://www.npmjs.com/package/@xpack-dev-tools/cmake/)
  - all releases [![npm](https://img.shields.io/npm/dt/@xpack-dev-tools/cmake)](https://www.npmjs.com/package/@xpack-dev-tools/cmake/)
