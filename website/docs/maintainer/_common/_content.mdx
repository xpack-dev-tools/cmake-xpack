...
(such as **3.30.9-1.1**) with the following expression:
...
- In `CHANGELOG.md`, add the release date and a message
  such as _**\* v3.30.9-1 released**_
...
tagged such as **v3.30.9-1** (mind the dash in the middle!) and
named such as **xPack CMake v3.30.9-1** (mind the dash),
...
- **Commit** all changes with the message
  _**package.json: update URLs for 3.30.9-1.1 release**_
