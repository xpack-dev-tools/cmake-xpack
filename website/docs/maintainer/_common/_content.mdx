...
```sh
npm run generate-top-commons -C ~/Work/xpack-dev-tools/cmake-xpack.git
```
...
- switch to https://xpack-dev-tools.github.io/cmake-xpack/docs/maintainer/#update-the-xpack-branch
