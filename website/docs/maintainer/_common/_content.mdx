...
**@xpack-dev-tools/cmake** is an xpm package that packages platform-specific archives, built with the [xPack Build Box (XBB)](https://xpack.github.io/xpack-build-box/).
...
```sh
rm -rf ~/Work/xpack-dev-tools/cmake-xpack.git/package-lock.json
```
...
npm --prefix ~/Work/xpack-dev-tools/cmake-xpack.git/build-assets install
xpm install -C ~/Work/xpack-dev-tools/cmake-xpack.git/build-assets
...
(such as **3.31.9-1.1**) with the following expression:
...
xpm run trigger-workflow-test-docker-linux-arm64 -C ~/Work/xpack-dev-tools/cmake-xpack.git/build-assets
```
...
- In `CHANGELOG.md`, add the release date and a message
  such as _**\* v3.31.9-1 released**_
...
tagged such as **v3.31.9-1** (mind the dash in the middle!) and
named such as **xPack CMake v3.31.9-1** (mind the dash),
...
- **Commit** all changes with the message
  _**package.json: update URLs for 3.31.9-1.1 release**_
...
- Navigate to the [GitHub Releases](https://github.com/xpack-dev-tools/cmake-xpack/releases) page
...
npm --prefix ~/Work/xpack-dev-tools/cmake-xpack.git/build-assets install && \
xpm install -C ~/Work/xpack-dev-tools/cmake-xpack.git/build-assets && \
xpm run test-release -C ~/Work/xpack-dev-tools/cmake-xpack.git/build-assets
```
