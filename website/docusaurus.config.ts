...
const config: Config = {
  ...
  projectName: 'cmake-xpack', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/xpack-dev-tools/cmake-xpack/edit/xpack/website/',
        ...
        sitemap: {
          ...
          priority: 0.5,
          ignorePatterns: [
            '/cmake-xpack/blog/archive/**',
            '/cmake-xpack/blog/authors/**',
            '/cmake-xpack/blog/tags/**'
          ],
  ...
  headTags: [
    {
      ...
      attributes: {
        rel: 'icon',
        type: 'image/png',
        href: '/cmake-xpack/favicons/favicon-48x48.png',
        sizes: '48x48'
      }
    },
    {
      ...
      attributes: {
        rel: 'icon',
        type: 'image/svg+xml',
        href: '/cmake-xpack/favicons/favicon.svg'
      }
    },
    {
      tagName: 'link',
      attributes: {
        rel: 'shortcut icon',
        href: '/cmake-xpack/favicons/favicon.ico'
      }
    },
    {
    ...
    },
    {
      ...
      attributes: {
        rel: 'manifest',
        href: '/cmake-xpack/favicons/site.webmanifest'
      }
    }
  ],
  ...
  themeConfig: {
    ...
    metadata: [
      {
        name: 'keywords',
        content: 'xpack, binary, development, tools, reproducibility, cmake'
      }
    ],
    navbar: {
      ...
      links: [
          ...
          items: [
            {
              ...
              href: 'https://github.com/xpack-dev-tools/cmake-xpack/discussions',
            },
            {
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'GitHub cmake-xpack project',
              href: 'https://github.com/xpack-dev-tools/cmake-xpack/',
            },
            {
