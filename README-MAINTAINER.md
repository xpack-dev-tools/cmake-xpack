...
Determine the version (like `3.24.4`) and update the `scripts/VERSION`
file; the format is `3.24.4-1`. The fourth number is the xPack release number
...
and fix them; assign them to a milestone (like `3.24.4-1`).
...
- add a new entry like _* v3.24.4-1 prepared_
- commit with a message like _prepare v3.24.4-1_
...
- checkout the `v3.24.4` tag
- create a branch like `v3.24.4-xpack`
- cherry pick the commit to _add cmd.exe support_ from a previous release;
  enable commit immediately
- push branch to `origin`
- add a `v3.24.4-1-xpack` tag; enable push to origin
- save as patch
- move to `patches`
- rename `cmake-3.24.4.git.patch`
...
total 39704
-rw-r--r--  1 ilg  staff  20182032 Jan 24 11:11 xpack-cmake-3.24.4-1-darwin-x64.tar.gz
-rw-r--r--  1 ilg  staff       105 Jan 24 11:11 xpack-cmake-3.24.4-1-darwin-x64.tar.gz.sha
```
...
total 38232
-rw-r--r--  1 ilg  staff  19090017 Jan 24 11:28 xpack-cmake-3.24.4-1-darwin-arm64.tar.gz
-rw-r--r--  1 ilg  staff       107 Jan 24 11:28 xpack-cmake-3.24.4-1-darwin-arm64.tar.gz.sha
```
...
total 23652
-rw-r--r-- 1 ilg ilg 24215471 Jan 24 09:30 xpack-cmake-3.24.4-1-linux-x64.tar.gz
-rw-r--r-- 1 ilg ilg      104 Jan 24 09:30 xpack-cmake-3.24.4-1-linux-x64.tar.gz.sha
```
...
total 21168
-rw-r--r-- 1 ilg ilg 21669972 Jan 24 09:36 xpack-cmake-3.24.4-1-win32-x64.zip
-rw-r--r-- 1 ilg ilg      101 Jan 24 09:36 xpack-cmake-3.24.4-1-win32-x64.zip.sha
```
...
total 21944
-rw-r--r-- 1 ilg ilg 22462984 Jan 24 09:57 xpack-cmake-3.24.4-1-linux-arm64.tar.gz
-rw-r--r-- 1 ilg ilg      106 Jan 24 09:57 xpack-cmake-3.24.4-1-linux-arm64.tar.gz.sha
```
...
total 21036
-rw-r--r-- 1 ilg ilg 21532829 Jan 24 09:55 xpack-cmake-3.24.4-1-linux-arm.tar.gz
-rw-r--r-- 1 ilg ilg      104 Jan 24 09:55 xpack-cmake-3.24.4-1-linux-arm.tar.gz.sha
```
...
bash ~/Work/xpack-dev-tools/cmake-xpack.git/xpacks/xpack-dev-tools-xbb-helper/github-actions/trigger-workflow-build.sh --machine xbbla64
...
```sh
.../xpack-cmake-3.24.4-1/bin/cmake --version
...
- in `CHANGELOG.md`, add the release date and a message like _* v3.24.4-1 released_
...
tagged like **v3.24.4-1** (mind the dash in the middle!) and
named like **xPack CMake v3.24.4-1** (mind the dash),
...
- commit the `develop` branch of `xpack/web-jekyll` GitHub repo;
  use a message like _xPack CMake v3.24.4-1 released_
- push to GitHub
...
- commit all changes, use a message like
  _package.json: update urls for 3.24.4-1.1 release_ (without _v_)

## Publish on the npmjs.com server

- select the `xpack-develop` branch
- check the latest commits `npm run git-log`
- update `CHANGELOG.md`, add a line like _* v3.24.4-1.1 published on npmjs.com_
- commit with a message like _CHANGELOG: publish npm v3.24.4-1.1_
- `npm pack` and check the content of the archive, which should list
  only the `package.json`, the `README.md`, `LICENSE` and `CHANGELOG.md`;
  possibly adjust `.npmignore`
- `npm version 3.24.4-1.1`; the first 5 numbers are the same as the
...
- `npm dist-tag add @xpack-dev-tools/cmake@3.24.4-1.1 latest`
- `npm dist-tag ls @xpack-dev-tools/cmake`

In case the previous version is not functional and needs to be unpublished:

- `npm unpublish @xpack-dev-tools/cmake@3.24.4-1.1`
...
- paste the release name like **xPack CMake v3.24.4-1 released**
