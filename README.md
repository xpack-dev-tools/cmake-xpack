...
```console
$ tree -L 2 /Users/ilg/Library/xPacks/\@xpack-dev-tools/cmake/3.24.4-1.1/.content/
/Users/ilg/Library/xPacks/\@xpack-dev-tools/cmake/3.24.4-1.1/.content/
├── README.md
├── bin
│   ├── ccmake
│   ├── cmake
...
like `3.24.4`; to this string the xPack distribution adds a four number,
but since semver allows only three numbers, all additional ones can
be added only as pre-release strings, separated by a dash,
like `3.24.4-1`. When published as a npm package, the version gets
a fifth number, like `3.24.4-1.1`.

Since adherence of third party packages to semver is not guaranteed,
it is recommended to use semver expressions like `^3.24.4` and `~3.24.4`
with caution, and prefer exact matches, like `3.24.4-1.1`.
