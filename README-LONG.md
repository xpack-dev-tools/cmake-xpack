...
```console
$ tree -L 2 /Users/ilg/Library/xPacks/\@xpack-dev-tools/cmake/3.27.9-1.2/.content/
/Users/ilg/Library/xPacks/\@xpack-dev-tools/cmake/3.27.9-1.2/.content/
├── README.md
├── bin
│   ├── ccmake
│   ├── cmake
...
a fifth number, like `3.27.9-1.2`.

Since adherence of third party packages to semver is not guaranteed,
it is recommended to use semver expressions like `^3.27.9` and `~3.27.9`
with caution, and prefer exact matches, like `3.27.9-1.2`.
